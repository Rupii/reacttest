...
function validate(employeeId, employeeName, track, subTrack, pu, location, subLocation, role, startdate) {
    return {
...
export default class Adddetails extends Component{
    ...
    axios.post('/addTeam', {team: this.state})
    .then(response =>{
        console.log("sent");
    })
    const { employeeId, employeeName , track, subTrack, pu, location, subLocation, role, startdate} = this.state;
    ...
    canBeSubmitted() {
        const errors = validate(this.state.employeeId, this.state.employeeName,this.state.track,
            ...
            this.state.role,this.state.startdate);
    ...
    componentDidMount(){
        if(this.props.item){
        const { employeeId, employeeName, track, subTrack, pu, location, subLocation, role, startdate} = this.props.item
        this.setState({ employeeId, employeeName, track, subTrack, pu, location, subLocation, role, startdate })
        }
    }
      ...
      return (
          <div>
            <div className="col-md-6 offset-md-3 details-body">           
                    ...
                    <div>
                        <h3 className="headerstyle">ADD DETAILS</h3>
                    ...
                    <Form  style={{backgroundColor:"white", width:"100%"}} >
                        ...
                        <div class="form-group">
                            ...
                            <Button variant="flat" onClick={this.onSubmit}>Submit</Button>
                        <span>   </span>
